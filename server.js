...
// Lógica de Login Centralizada e Otimizada
app.post('/api/login', async (req, res) => {
    const { username, password } = req.body;

    // 1. Verifica se é o Master do .env
    ...
    try {
        // 2. Busca na tabela usuarios (Banco Clean)
        ...
        if (userFound) {
            // Sincroniza o status na botconfig ao logar
